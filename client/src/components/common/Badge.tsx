...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border tracking-wide uppercase whitespace-nowrap shrink-0 ${variants[variant] ?? variants.slate} ${sizes[size]}`}
    >
      {dot && (
