...
import { Menu, LogOut, Bell, Sun, Moon, ShieldCheck, ChevronRight, Activity } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2 sm:space-x-3">
        ...
        {/* Notifications */}
        <button
          className="relative p-2 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800/80 border border-transparent hover:border-slate-700 transition-colors"
          title="Notifications"
        >
        ...
        {/* Profile / User */}
        <div className="flex items-center space-x-3">
          <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-brand-600 to-indigo-600 flex items-center justify-center text-white font-extrabold text-xs shadow-glow-sm shrink-0">
